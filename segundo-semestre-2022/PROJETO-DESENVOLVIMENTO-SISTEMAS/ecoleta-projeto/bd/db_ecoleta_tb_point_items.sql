...
--
-- Table structure for table `tb_point_items`
--

DROP TABLE IF EXISTS `tb_point_items`;
...
--
-- Dumping data for table `tb_point_items`
--

LOCK TABLES `tb_point_items` WRITE;
/*!40000 ALTER TABLE `tb_point_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_point_items` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-10-26 19:52:08
