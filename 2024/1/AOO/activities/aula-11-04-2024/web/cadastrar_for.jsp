...
<html lang="en">
    <head>
        <title>CRUD MVC - Cadastro - FORNECEDOR - Java DB</title>
        <meta charset="utf-8">
        ...
        <div class="container col-md-6 col-md-offset-3">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title h1">Novo Cadastro - FORNECEDOR</h3>
                </div>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-lg-6 col-lg-offset-2">
                                    <button type="submit" name="acao" class="btn btn-warning" value="cadastrar_for">Cadastrar</button>
                                </div>
                            </div>
                        </fieldset>
                    </form>        
