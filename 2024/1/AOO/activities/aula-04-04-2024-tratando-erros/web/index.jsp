        ...
        <div id="frm">
            <form action="ExTrataErrosJSP_Dados.jsp" name="frmItens" method="post">
                <pre>
                    ...
                    Unidade:            
                    <input type="text" name="unidade" size="40">

                    Saldo:              
                    <input type="text" name="saldo" size="40">

                    Valor unitário:
                    <input type="text" name="valorUnitario" size="40">

                    Observações:        
                    <input type="text" name="obs" size="40">

                    <input type="submit" value="Incluir" name="action"><input id="reset" type="reset" value="Limpar" name="limpar">
                </pre>
            </form>
        </div>
    </body>
